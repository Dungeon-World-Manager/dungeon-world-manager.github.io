        ...
        <React.Fragment>
            ...
            <div class='ui stackable three column grid'>
                <div class='column'>
                    ...
                    <p>
                        Dungeon World is an open source table top roleplaying
                        game.
                    </p>
                </div>
                ...
                <div class='column'>
                    ...
                    <p>
                        ...
                        talking about the action and less time talking about the
                        rules.
                    </p>
                </div>
                {/* Vs DnD */}
                <div class='column'>
                    ...
                    <p>
                        Dungeon World uses the Powered by the Apocalypse engine.
                    </p>
                    <p>
                        Story-driven world building and character development -
                        experience is gained by progressing the story and
            ...
            <div class='ui stackable two column grid'>
                ...
                <div class='column'>
                    ...
                    <p>
                        Dungeon World allows for endless customization. Use DW
                        manager to create materials based on your
                        customizations. Just enter your custom details and the
                        app can generate a printable pdf of your custom class.
                    </p>
                </div>
                {/* Manage Sessions */}
                <div class='column'>
                    ...
                    <p>
                        Streamline communication between the GM and the players.
                    </p>
                    <p></p>
                </div>
                ...
                <div class='column'>
                    ...
                    <p>
                        Share your creations through the app, and browse what
                        others have created to expand your own play sessions.
                    </p>
                </div>
            </div>

            {/* CTA */}
            <h2 class='ui center aligned grid'>
            ...
            <div class='ui stackable three column grid'>
                ...
                <div class='column'>
                    ...
                    <p>
                        Create an account to play sessions with others [Benefits
