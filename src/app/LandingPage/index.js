...
export default class LandingPage extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Segment fluid color="red" textAlign="center">
          <Header as="h1">DW Manager</Header>
          <Header as="h3">Start or join a Dungeon World Session Now!</Header>
          <Button as={Link} to='/sessions' color="red" size="massive" circular>
            <Icon name="users" />
            Sessions
          </Button>
        </Segment>
        ...
        <Accordion>
          ...
          <Accordion.Content active={activeIndex === 0}>
            <p>
              Dungeon World is an open source table top roleplaying game.
